...
Den dynamiska prisberäkningen implementerades i App.jsx genom att multiplicera antal valda säten med filmens pris:

```
const total = count * price;
```

Först funderade jag på att lägga totalen i state, men insåg att det räcker som ett beräknat värde. Genom att beräkna totalen direkt istället för att lagra den i state undvek jag onödig state-hantering. Det gjorde koden enklare, mer logisk och minskade risken för att olika värden skulle hamna ur synk.
